...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mobile: pin to viewport with 1rem margin via max-w-[calc(100%-2rem)]
        // — the default `max-w-lg` (32rem) would push past phone edges.
        // Desktop unchanged via sm:max-w-lg.
